        ...
        <SettingsPanel
          ...
          copy={{
            ...
            table: {
              ...
              description: t('admin.settings.systemSettings.table.description'),
            ...
            valueHelperText: t('admin.settings.systemSettings.valueHelperText'),
            invalidValueError: t(
              'admin.settings.systemSettings.invalidValueError',
            ),
            formCreateTitle: t('admin.settings.systemSettings.formCreateTitle'),
        ...
        <FeatureFlagsPanel
          ...
          copy={{
            ...
            fields: {
              ...
              description: t('admin.settings.featureFlags.fields.description'),
            },
            ...
            emptyDescription: t('admin.settings.featureFlags.emptyDescription'),
