...
function Harness() {
  ...
  return (
    <div>
      <button type="button" onClick={() => mutate({ id: 7, steps: STEPS })}>
        save
      </button>
...
describe('useReplaceListingItineraryMutation (apps/web/src/modules/listings)', () => {
  ...
  test('calls replaceListingItinerarySteps(id, steps) and invalidates the detail cache', async () => {
    ...
    expect(replaceListingItinerarySteps).toHaveBeenCalledWith(7, STEPS);
